...
namespace WebApp.Areas.Identity.Pages.Account.Manage
{
    public class IndexModel : PageModel
    {
        ...
        public IndexModel(
            ...
            SignInManager<ApplicationUser> signInManager, RentalDBContext context)
        {
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            ...
            User mainDBUser = _context.Users.FirstOrDefault(u => u.Id == user.UserID);
            ...
            if (user.FirstName != Input.FirstName)
            {
                ...
                mainDBUser.FirstName = Input.FirstName;
            }

            if (user.LastName != Input.LastName)
            {
                user.LastName = Input.LastName;
                mainDBUser.LastName = Input.LastName;
            }
            ...
            if (Input.PhoneNumber != phoneNumber)
            {
                ...
                mainDBUser.PhoneNumber = Input.PhoneNumber;
            ...
            _context.Users.Update(mainDBUser);
            _context.SaveChanges();
            // Save changes to FirstName / LastName
