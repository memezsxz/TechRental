...
public class S3Uploader
{
    ...
    public async Task<string> UploadFileAsync(Stream fileStream, string fileName, string fileExtension)
    {
    ...
    public async Task<Stream> GetFileByGuidAsync(string guid)
    {
